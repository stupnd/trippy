                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className={`w-14 h-14 ${colorClass} rounded-full flex items-center justify-center text-white font-bold text-base border-2 border-slate-200 dark:border-white/20 ${
                          !member.hasPreferences ? 'animate-pulse' : ''
                        }`}>
                          {initials}
                        </div>
